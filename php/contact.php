...
$curl = curl_init();
$link = 'https://demoweb.go.yo.fr/contact.php';
$name = $post["name"];
...
if ($email) {
  $allPost = "Ce mail a été envoyé via la page contact du site web.

  Nom : " . $name . "
  Prénom : " . $firstName . "
  Email : " . $email . "
  Téléphone : " . $phone . "
  Validation : " . $checkbox = "OK" . "

  " . htmlspecialchars($message);

  mail("bouteille.menuiseries@gmail.com", $object,  $allPost, "FROM: Contact@website.fr" . "\r\nReply-to:" . $email);
